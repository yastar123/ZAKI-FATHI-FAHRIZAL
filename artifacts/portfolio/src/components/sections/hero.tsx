...
export default function Hero() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-[100dvh] flex flex-col justify-center overflow-hidden pt-14 md:pt-20">
      ...
      {/* HUD readouts — sm and up */}
      <div className="absolute top-16 sm:top-20 right-3 sm:right-6 md:right-12 z-20 font-mono text-[9px] sm:text-[10px] text-primary border border-primary/30 p-1.5 sm:p-2 bg-background/50 backdrop-blur-sm hidden sm:block">
      ...
      >
        ...
        <div className="relative font-display text-[16vw] sm:text-[13vw] md:text-[12vw] leading-[0.85] tracking-tight uppercase z-10">
          <motion.div
        ...
        <motion.div
          className="max-w-[85vw] sm:max-w-md lg:max-w-xl border-l-2 border-primary pl-4 md:pl-6 py-2 mt-8 md:mt-16 backdrop-blur-sm bg-background/30 relative"
        ...
        >
          ...
          <div className="mt-3 md:mt-6 flex flex-col gap-1.5 md:gap-2 font-mono text-[10px] sm:text-xs text-muted-foreground uppercase">
            <span className="flex items-center gap-2">
              <span className="text-primary">{">"}</span> CFD • FEA • Thermo-Structural
            </span>
            <span className="flex items-center gap-2">
              <span className="text-primary">{">"}</span> Sydney, AU + Baturaja, ID
            </span>
            <span className="flex items-center gap-2">
        ...
        {/* CTA buttons */}
        <motion.div
          className="flex flex-wrap gap-3 mt-6 md:mt-10"
        ...
        >
          <a
            href="#projects"
            className="font-mono text-[11px] sm:text-xs uppercase tracking-widest bg-primary text-primary-foreground px-4 sm:px-5 py-2.5 hover:bg-primary/90 transition-colors relative overflow-hidden group"
          >
            <span className="relative z-10">VIEW PROJECTS</span>
          </a>
          <a
            href="#contact"
            className="font-mono text-[11px] sm:text-xs uppercase tracking-widest border border-primary text-primary px-4 sm:px-5 py-2.5 hover:bg-primary hover:text-primary-foreground transition-all relative overflow-hidden group"
          >
      ...
      {/* Scroll indicator */}
      <motion.div
        className="absolute bottom-6 sm:bottom-8 md:bottom-12 left-4 sm:left-8 md:left-12 z-20 font-mono flex items-center gap-3 text-xs text-primary"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      {/* Horizontal data ticker — all devices */}
